...
cp ${vdo_root}/${doc_name}/${project_name}//sites/default/default.settings.php ${vdo_root}/${doc_name}/${project_name}//sites/default/settings.php ;
...
];" >> ${vdo_root}/${doc_name}/${project_name}//sites/default/settings.php ;

mkdir ${vdo_root}/${doc_name}/${project_name}/config ;
mkdir ${vdo_root}/${doc_name}/${project_name}/config/sync ;
echo "\$settings['config_sync_directory'] = '${config_sync_directory}';" >> ${vdo_root}/${doc_name}/${project_name}//sites/default/settings.php ;
