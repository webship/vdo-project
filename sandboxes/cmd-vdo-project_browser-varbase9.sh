...
echo "*----------------------------------------------------------------------*";
echo "|  Build Project Browser module under Varbase 9                        |";
echo "*----------------------------------------------------------------------*";
...
base_url="${vdo_host}/${doc_name}/${project_name}/docroot";
echo "Go to ${base_url}";
