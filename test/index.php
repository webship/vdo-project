    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col col-12 py-5">
          <h1 class="mb-4 display-1 text-center"><a href="/"> VDO</a> <i class="fas fa-vial fa-2x my-2"></i> Test</h1>
        </div>
      </div>
    </div>
      ...
      <div class="col col-12 py-5">
        ...
        foreach($files as $key => $value){
          if(is_dir($current_directory . DIRECTORY_SEPARATOR . $value) && !in_array($value,array(".","..","backups"))) {
            ...
            foreach($docroot_options as $docroot_option) {
              if (is_dir($project_path . '/' . $docroot_option)) {
                ...
                if ($is_ddev) {
                  ...
                  $href = '/test/' . $value . '/' . $docroot_option;
                }
                break;
              }
            }
            ...
            echo '
            <a href="'. $href . '" class="w-100 pr-3 py-4">
              <div class="card border-0 shadow-lg shadow-hover">
                <div class="card-body">
                  <h4><i class="fab fa-drupal fa-2x mr-2"></i>' . $value . '</h4>
