...
<html lang="en">
  <head>
    ...
    <title>VDO Themes</title>
  </head>
  <body>
      <div class="container-fluid">
        <div class="row align-items-center">
          <div class="col col-12 py-5">
            <h1 class="mb-4 display-1 text-center"><a href="/"><img alt="VDO" style="height: 1em;" src="https://raw.githubusercontent.com/webship/vdo/9.0.x/images/logo.svg">  VDO</a> <i class="fal fa-paint-brush-alt fa-1x mr-2"></i> Themes</h1>
          </div>
        </div>
      </div>
    <div class="container-fluid">
...
<?php
           ...
           $files = scandir($current_directory);
            ...
            foreach($files as $key => $value){
              if(is_dir($current_directory . DIRECTORY_SEPARATOR . $value) && !in_array($value,array(".","..","backups","template_drupal"))) {
		      $docroot = '/docroot';
		      $href = '/themes/' . $value . '/docroot/';
			      if (!is_dir($current_directory . DIRECTORY_SEPARATOR . $value . '/docroot/')) {
				      if (is_dir($current_directory . DIRECTORY_SEPARATOR . $value . '/web/')) {
                                         $href = '/themes/' . $value . '/web/';
				      }
			      }
