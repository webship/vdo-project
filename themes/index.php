    ...
    <div class="container-fluid">
      <div class="row align-items-center">
        <div class="col col-12 py-5">
          <h1 class="mb-4 display-1 text-center"><a href="/">  VDO</a> <i class="fal fa-paint-brush-alt fa-1x mr-2"></i> Themes</h1>
        </div>
      </div>
        </div>
  <div class="container-fluid">
      ...
      <div class="row">
          ...
          if(is_dir($current_directory . DIRECTORY_SEPARATOR . $value) && !in_array($value,array(".","..","backups","template_drupal"))) {
              // Check for common document root directories
              $docroot_options = ['docroot', 'web', 'app', 'webapp', 'html', 'public_html'];
              $docroot_found = '';
              $href = '';
              ...
              if (is_dir($current_directory . DIRECTORY_SEPARATOR . $value . '/' . $docroot_option)) {
                  ...
                  $href = '/themes/' . $value . '/' . $docroot_option . '/';
                  break;
              }
              }
