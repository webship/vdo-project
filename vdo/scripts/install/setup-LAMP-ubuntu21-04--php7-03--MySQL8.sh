...
apt install -y php7.3-pspell;
apt install -y php7.3-sqlite3;
apt install -y php7.3-tidy;
apt install -y php7.3-opcache;
apt install -y php7.3-json;
apt install -y php7.3-bz2;
apt install -y php7.3-readline;
apt install -y php7.3-xmlrpc;
apt install -y php7.3-enchant;
apt install -y php7.3-xsl;
apt install -y php-all-dev;
apt install -y php7.3-zip;
apt install -y php7.3-bcmath;
apt install -y php-pear;

# Set the Apache2 enable mode to php7.3
a2enmod php7.3 ;
...
echo 'max_execution_time = 1200' >> /etc/php/7.3/apache2/php.ini ;
echo 'max_input_time = 180' >> /etc/php/7.3/apache2/php.ini ;
echo 'max_input_vars = 10000' >> /etc/php/7.3/apache2/php.ini ;
echo 'memory_limit = -1' >> /etc/php/7.3/apache2/php.ini ;
echo 'error_reporting = E_ALL' >> /etc/php/7.3/apache2/php.ini ;
echo 'post_max_size = 64M' >> /etc/php/7.3/apache2/php.ini ;
echo 'upload_max_filesize = 32M' >> /etc/php/7.3/apache2/php.ini ;
echo 'max_file_uploads = 40' >> /etc/php/7.3/apache2/php.ini ;
