...
echo '------------------------------------------------------------------------';
echo '  Git clone all Uber Publisher projects for 8.x-4.x';
echo '------------------------------------------------------------------------';
...
git clone --branch 8.x-4.x git@github.com:Vardot/uber_publisher-project.git ;
git remote rename origin github ;

# Uber Publisher profile.
# ------------------------------------------------------------------------------
if [ -d "uber_publisher" ]; then rm -rf uber_publisher; fi
git clone --branch 8.x-4.x git@git.drupal.org:project/uber_publisher.git ;
...
git clone --branch 8.x-4.x git@git.drupal.org:project/uber_publisher_core.git ;
git remote rename origin drupal;
...
git clone --branch 8.x-4.x git@git.drupal.org:project/uber_publisher_opinion_articles.git ;
git remote rename origin drupal;
...
git clone --branch 8.x-4.x git@git.drupal.org:project/uber_publisher_author_profile.git ;
git remote rename origin drupal;
...
git clone --branch 8.x-4.x git@git.drupal.org:project/uber_publisher_breaking_news.git ;
git remote rename origin drupal;
...
git clone --branch 8.x-4.x git@git.drupal.org:project/uber_publisher_daily_cartoons.git ;
git remote rename origin drupal;
...
git clone --branch 8.x-4.x git@git.drupal.org:project/uber_publisher_in_pictures.git ;
git remote rename origin drupal;
...
git clone --branch 8.x-4.x git@git.drupal.org:project/uber_publisher_search.git ;
git remote rename origin drupal;
...
git clone --branch 8.x-4.x git@git.drupal.org:project/uber_publisher_social_post.git ;
git remote rename origin drupal;
...
git clone --branch 8.x-4.x git@git.drupal.org:project/uber_publisher_ads_system.git ;
git remote rename origin drupal;
