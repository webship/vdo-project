...
echo '------------------------------------------------------------------------';
echo '  Git clone all Varbase projects for 8.x-4.x';
echo '------------------------------------------------------------------------';
...
git clone --branch 8.4.x git@git.drupal.org:project/varbase-project.git ;
...
git clone --branch 8.x-4.x git@git.drupal.org:project/varbase.git ;
...
git clone --branch 8.x-4.x git@git.drupal.org:project/varbase_bootstrap_paragraphs.git ;
git remote rename origin drupal;
...
git clone --branch 8.x-4.x git@git.drupal.org:project/varbase_landing.git ;
git remote rename origin drupal;
git remote add github git@github.com:Vardot/varbase_landing.git ;

if [ -d "varbase_carousels" ]; then rm -rf varbase_carousels; fi
git clone --branch 8.x-4.x git@git.drupal.org:project/varbase_carousels.git ;
git remote rename origin drupal;
...
git clone --branch 8.x-1.x git@git.drupal.org:project/varbase_total_control.git ;
git remote rename origin drupal;
...
git clone --branch 8.x-4.x git@git.drupal.org:project/varbase_styleguide.git ;
git remote rename origin drupal;
...
git clone --branch 8.x-4.x git@git.drupal.org:project/vartheme.git ;
git remote rename origin drupal;
git remote add github git@github.com:Vardot/vartheme.git ;

if [ -d "vartheme_admin" ]; then rm -rf vartheme_admin; fi
git clone --branch 8.x-4.x git@git.drupal.org:project/vartheme_admin.git ;
git remote rename origin drupal;
...
git clone --branch 8.x-4.x git@git.drupal.org:project/varbase_faqs.git ;
git remote rename origin drupal;
git remote add github git@github.com:Vardot/varbase_faqs.git ;

if [ -d "varbase_reports" ]; then rm -rf varbase_reports; fi
# git clone --branch 8.x-4.x git@git.drupal.org:project/varbase_reports.git ;
git remote rename origin drupal;
...
git clone --branch 8.x-4.x git@github.com:Vardot/varbase_vmi_demo.git ;
git remote rename origin github ;

if [ -d "varbase_story_demo" ]; then rm -rf varbase_story_demo; fi
git clone --branch 8.x-4.x git@github.com:Vardot/varbase_story_demo.git ;
git remote rename origin github ;
