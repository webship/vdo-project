...
echo '------------------------------------------------------------------------';
echo '  Git clone all Varbase projects for 8.x-6.x';
echo '------------------------------------------------------------------------';
...
git clone --branch 8.6.x git@github.com:Vardot/varbase-project.git ;
...
git clone --branch 8.x-6.x git@git.drupal.org:project/varbase.git ;
...
git clone --branch 8.x-6.x git@git.drupal.org:project/varbase_blog.git ;
git remote rename origin drupal;
...
git clone --branch 8.x-6.x git@git.drupal.org:project/varbase_bootstrap_paragraphs.git ;
git remote rename origin drupal;
...
git clone --branch 8.x-6.x git@git.drupal.org:project/varbase_landing.git ;
git remote rename origin drupal;
git remote add github git@github.com:Vardot/varbase_landing.git ;

if [ -d "varbase_carousels" ]; then rm -rf varbase_carousels; fi
git clone --branch 8.x-6.x git@git.drupal.org:project/varbase_carousels.git ;
git remote rename origin drupal;
...
git clone --branch 8.x-6.x git@git.drupal.org:project/varbase_heroslider_media.git ;
git remote rename origin drupal;
