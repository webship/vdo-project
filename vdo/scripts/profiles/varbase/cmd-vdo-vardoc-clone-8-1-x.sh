...
echo '------------------------------------------------------------------------';
echo '  Git clone all Vardoc projects for 8.x-1.x';
echo '------------------------------------------------------------------------';
...
git clone --branch 8.x-1.x git@github.com:Vardot/vardoc-project.git ;
git remote rename origin github ;

# Vardoc profile project.

if [ -d "vardoc" ]; then rm -rf vardoc; fi
git clone --branch 8.x-1.x git@git.drupal.org:project/vardoc.git ;
